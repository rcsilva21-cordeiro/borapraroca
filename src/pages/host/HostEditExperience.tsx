...
export default function HostEditExperience() {
  ...
  if (!experience || (user && experience.host_id !== user.id)) {
    return (
      <div className="text-center py-20">
        <p className="text-muted-foreground">Experiência não encontrada.</p>
        <Button variant="outline" className="mt-4" onClick={() => navigate("/hospedeiro/experiencias")}>
          Voltar
        </Button>
      </div>
    );
    ...
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Atualize os dados da sua experiência.
        </p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader><CardTitle className="font-display text-lg">Status</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader><CardTitle className="font-display text-lg">Informações Básicas</CardTitle></CardHeader>
        ...
        <Card>
          <CardHeader><CardTitle className="font-display text-lg">Detalhes</CardTitle></CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader><CardTitle className="font-display text-lg">Faixas Etárias</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader><CardTitle className="font-display text-lg">Fotos ({totalPhotos}/15)</CardTitle></CardHeader>
          <CardContent>
            ...
            {totalPhotos < 15 && (
              <div onClick={() => fileInputRef.current?.click()}
                ...
                <p className="text-sm text-muted-foreground mt-1">JPG, PNG ou WebP • Máximo 15 fotos</p>
              </div>
            )}
          </CardContent>
        </Card>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-end">
          <Button type="button" variant="outline" onClick={() => navigate("/hospedeiro/experiencias")}>
            Cancelar
          </Button>
